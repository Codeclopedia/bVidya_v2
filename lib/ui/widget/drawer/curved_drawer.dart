...
class CurvedDrawer extends StatefulWidget {
  ...
  CurvedDrawer(
      ...
      this.buttonBackgroundColor = Colors.red,
...
class _CurvedDrawerState extends State<CurvedDrawer>
  ...
  late int _endingIndex = 0;
  late double _pos;
  late double _buttonHide = 0;
  late DrawerNavItem _icon;
  late AnimationController _animationController;
  late int _length;
  late int _isEnd;
  late List<DrawerNavItem> _items;
              ...
              Positioned(
                  ...
                  child: CustomPaint(
                      painter: DrawerCustomPainter(
                          ...
                          widget.isEndDrawer),
                      child:
                          SizedBox(width: widget.width, height: size.height))),
              Positioned(
                top: 0,
                bottom: 0,
                left: widget.isEndDrawer ? null : 0,
