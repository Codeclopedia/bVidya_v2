...
Future showBasicImageDialog(BuildContext context, Widget title, String message,
        String positiveButton, Future Function() positiveAction,
        {String? negativeButton, Future Function()? negativeAction}) =>
    showDialog(
      context: context,
...
class BasicImageDialogContent extends StatelessWidget {
  final Widget title;
  final String message;
  final String positiveButton;
  final String negativeButton;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Padding(
              padding: EdgeInsets.only(left: 6.w, right: 6.w), child: title),
          Padding(
            padding: EdgeInsets.only(top: 1.5.h, left: 6.w, right: 6.w),
            child: Text(
              message,
